...
import org.william.cex.repository.AuditLogRepository;
...
public class AdminService {
    ...
    @Transactional
    public void recordAuditAction(Long adminId, String action, String resource, Object changes, String ipAddress) {
        JsonNode changeNode = changes == null ? null : objectMapper.valueToTree(changes);
